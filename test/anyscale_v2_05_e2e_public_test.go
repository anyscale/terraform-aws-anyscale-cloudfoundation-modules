...
func TestAnyscalev2_e2e_public(t *testing.T) {
	t.Parallel()
	...
	terraformOptions := &terraform.Options{
		...
		TerraformDir: "./anyscale-v2-e2e-public-test",
	...
	// Check subnets
	anyscale_v2_public_subnet_ids := terraform.OutputList(t, terraformOptions, "anyscale_v2_public_subnet_ids")
	assert.Contains(t, anyscale_v2_public_subnet_ids[0], "subnet-")
	...
	assert.True(t, aws.IsPublicSubnet(t, anyscale_v2_public_subnet_ids[0], awsRegion))
