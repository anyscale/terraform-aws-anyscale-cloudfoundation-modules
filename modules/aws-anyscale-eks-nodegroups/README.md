...
| <a name="input_eks_management_update_config"></a> [eks\_management\_update\_config](#input\_eks\_management\_update\_config) | (Optional) Configuration settings for max unavailable resources during Management Node Group updates.<br><br>ex:<pre>eks_management_update_config = {<br>  max_unavailable_percentage = 33,<br>  max_unavailable            = 5<br>}</pre> | `map(string)` | <pre>{<br>  "max_unavailable_percentage": 33<br>}</pre> | no |
