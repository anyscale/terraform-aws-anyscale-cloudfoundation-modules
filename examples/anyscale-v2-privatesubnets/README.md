...
| <a name="input_anyscale_org_id"></a> [anyscale\_org\_id](#input\_anyscale\_org\_id) | (Required) Anyscale Organization ID.<br/>This is used for tagging resources.<br/>If the variable `anyscale_external_id` is provided, this is also<br/>prepended to the external ID for the control plane IAM role trust policy.<br/><br/>ex:<pre>anyscale_org_id = "org_1234567890"</pre> | `string` | n/a | yes |
